...
EXAMPLE_ROOT = Path(__file__).resolve().parent.parent / "examples" / "palamedes_agents_skills"
REGISTRY_PATH = EXAMPLE_ROOT / "registry.py"
_REGISTRY_SPEC = importlib.util.spec_from_file_location("palamedes_agents_skills_registry_example", REGISTRY_PATH)
...
class PalamedesAgentsSkillsExampleTests(unittest.TestCase):
