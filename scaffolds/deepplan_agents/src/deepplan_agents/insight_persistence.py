#!/usr/bin/env python3
"""Convert grounded strategy insights into DeepPlan evidence/replan writes."""
...
def persist_reference_insights(adapter: DeepPlanAdapter, report: Dict[str, Any]) -> Dict[str, Any]:
